        ...
        <Col  {...colsProps}>
          ...
          >
            <CardBody>
              ...
              <img alt='pricing svg' src='http://127.0.0.1:3001/src/assets/images/illustration/Pot1.svg' />
              {/* <h3>{item.title}</h3> */}
              <h3>Basic</h3>
        ...
        <Col  {...colsProps}>
          ...
          >
            <CardBody>
              ...
              {/* <img className={imgClasses} src={item.img} alt='pricing svg' /> */}
              <img alt='pricing svg' src='http://127.0.0.1:3001/src/assets/images/illustration/Pot2.svg' />
              {/* <h3>{item.title}</h3> */}
              <h3>Standard
              </h3>
              {/* <CardText>{item.subtitle}</CardText> */}
